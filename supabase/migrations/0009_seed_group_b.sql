...
-- Orden por páginas: Canadá (16-17), Bosnia (18-19), Qatar (20-21), Suiza (22-23).
...
begin
  ...
  insert into public.stickers (album_id, code, number, name, team, group_code, type, rarity, page) values
    ...
    -- Qatar (18-19)
    (v_album_id, 'QAT1',  1,  'Escudo de Qatar',          'Qatar', 'B', 'shiny',  2, 20),
    (v_album_id, 'QAT2',  2,  'Meshaal Barsham',          'Qatar', 'B', 'normal', 1, 20),
    (v_album_id, 'QAT3',  3,  'Sultan Albrake',           'Qatar', 'B', 'normal', 1, 20),
    (v_album_id, 'QAT4',  4,  'Lucas Mendes',             'Qatar', 'B', 'normal', 1, 20),
    (v_album_id, 'QAT5',  5,  'Homam Ahmed',              'Qatar', 'B', 'normal', 1, 20),
    (v_album_id, 'QAT6',  6,  'Boualem Khoukhi',          'Qatar', 'B', 'normal', 1, 20),
    (v_album_id, 'QAT7',  7,  'Pedro Miguel',             'Qatar', 'B', 'normal', 1, 20),
    (v_album_id, 'QAT8',  8,  'Tarek Salman',             'Qatar', 'B', 'normal', 1, 20),
    (v_album_id, 'QAT9',  9,  'Mohamed Al-Mannai',        'Qatar', 'B', 'normal', 1, 20),
    (v_album_id, 'QAT10', 10, 'Karim Boudiaf',            'Qatar', 'B', 'normal', 1, 20),
    (v_album_id, 'QAT11', 11, 'Assim Madibo',             'Qatar', 'B', 'normal', 1, 21),
    (v_album_id, 'QAT12', 12, 'Ahmed Fatehi',             'Qatar', 'B', 'normal', 1, 21),
    (v_album_id, 'QAT13', 13, 'Team Photo (Plantel)',     'Qatar', 'B', 'special', 2, 21),
    (v_album_id, 'QAT14', 14, 'Mohammed Waad',            'Qatar', 'B', 'normal', 1, 21),
    (v_album_id, 'QAT15', 15, 'Abdulaziz Hatem',          'Qatar', 'B', 'normal', 1, 21),
    (v_album_id, 'QAT16', 16, 'Hassan Al-Haydos',         'Qatar', 'B', 'normal', 1, 21),
    (v_album_id, 'QAT17', 17, 'Edmilson Junior',          'Qatar', 'B', 'normal', 1, 21),
    (v_album_id, 'QAT18', 18, 'Akram Hassan Afif',        'Qatar', 'B', 'normal', 1, 21),
    (v_album_id, 'QAT19', 19, 'Ahmed Al Ganehi',          'Qatar', 'B', 'normal', 1, 21),
    (v_album_id, 'QAT20', 20, 'Almoez Ali',               'Qatar', 'B', 'normal', 1, 21),

    -- Bosnia y Herzegovina (20-21)
    (v_album_id, 'BIH1',  1,  'Escudo de Bosnia y Herzegovina', 'Bosnia y Herzegovina', 'B', 'shiny',  2, 18),
    (v_album_id, 'BIH2',  2,  'Nikola Vasilj',            'Bosnia y Herzegovina', 'B', 'normal', 1, 18),
    (v_album_id, 'BIH3',  3,  'Amer Dedić',               'Bosnia y Herzegovina', 'B', 'normal', 1, 18),
    (v_album_id, 'BIH4',  4,  'Sead Kolašinac',           'Bosnia y Herzegovina', 'B', 'normal', 1, 18),
    (v_album_id, 'BIH5',  5,  'Tarik Muharemović',        'Bosnia y Herzegovina', 'B', 'normal', 1, 18),
    (v_album_id, 'BIH6',  6,  'Nihad Mujakić',            'Bosnia y Herzegovina', 'B', 'normal', 1, 18),
    (v_album_id, 'BIH7',  7,  'Nikola Katić',             'Bosnia y Herzegovina', 'B', 'normal', 1, 18),
    (v_album_id, 'BIH8',  8,  'Amir Hadžiahmetović',      'Bosnia y Herzegovina', 'B', 'normal', 1, 18),
    (v_album_id, 'BIH9',  9,  'Benjamin Tahirović',       'Bosnia y Herzegovina', 'B', 'normal', 1, 18),
    (v_album_id, 'BIH10', 10, 'Armin Gigović',            'Bosnia y Herzegovina', 'B', 'normal', 1, 18),
    (v_album_id, 'BIH11', 11, 'Ivan Šunjić',              'Bosnia y Herzegovina', 'B', 'normal', 1, 19),
    (v_album_id, 'BIH12', 12, 'Ivan Bašić',               'Bosnia y Herzegovina', 'B', 'normal', 1, 19),
    (v_album_id, 'BIH13', 13, 'Team Photo (Plantel)',     'Bosnia y Herzegovina', 'B', 'special', 2, 19),
    (v_album_id, 'BIH14', 14, 'Dženis Burnić',            'Bosnia y Herzegovina', 'B', 'normal', 1, 19),
    (v_album_id, 'BIH15', 15, 'Esmir Bajraktarević',      'Bosnia y Herzegovina', 'B', 'normal', 1, 19),
    (v_album_id, 'BIH16', 16, 'Amar Memić',               'Bosnia y Herzegovina', 'B', 'normal', 1, 19),
    (v_album_id, 'BIH17', 17, 'Ermedin Demirović',        'Bosnia y Herzegovina', 'B', 'normal', 1, 19),
    (v_album_id, 'BIH18', 18, 'Edin Džeko',               'Bosnia y Herzegovina', 'B', 'normal', 1, 19),
    (v_album_id, 'BIH19', 19, 'Samed Baždar',             'Bosnia y Herzegovina', 'B', 'normal', 1, 19),
    (v_album_id, 'BIH20', 20, 'Haris Tabaković',          'Bosnia y Herzegovina', 'B', 'normal', 1, 19),
